...
public class ModernAmmo extends GameObject {
	
	public ModernAmmo(Vector position, Vector velocity) {
		super(position, new Size(18, 18), SpriteID.ModernAmmo);
		this.setVelocity(velocity);
	}
	
	public String toString() {
		return "ModernAmmo " + this.getPosition();
	}
